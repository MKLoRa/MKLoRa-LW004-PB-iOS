...
@interface MKPBLoRaSettingConfigModel : NSObject
...
@interface MKPBLoRaSettingModel : NSObject

@property (nonatomic, strong, readonly)MKPBLoRaSettingConfigModel *configModel;

...
@implementation MKPBAboutController

- (void)dealloc {
    NSLog(@"MKPBAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-PB", @"MKPBAboutController", @"pb_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UILabel *)firmwareLabel{
    if (!_firmwareLabel) {
        ...
        _firmwareLabel.text = @"FW Version:V3.1";
    }
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-PB", @"MKPBAboutController", @"pb_aboutBottomIcon.png");
    }
    return _bottomIcon;
}

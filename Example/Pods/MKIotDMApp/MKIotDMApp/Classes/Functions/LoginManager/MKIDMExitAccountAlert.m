...
@interface MKIDMExitAccountAlert ()
...
@property (nonatomic, copy) void (^exitCompletion)(void);

@end

@implementation MKIDMExitAccountAlert

- (void)dealloc {
    NSLog(@"MKIDMExitAccountAlert销毁");
}
...
- (void)showWithAccount:(NSString *)account
    ...
    self.exitCompletion = nil;
    self.exitCompletion = completion;
...
- (UIButton *)exitButton {
    if (!_exitButton) {
        ...
        [_exitButton.titleLabel setFont:MKFont(16.f)];
